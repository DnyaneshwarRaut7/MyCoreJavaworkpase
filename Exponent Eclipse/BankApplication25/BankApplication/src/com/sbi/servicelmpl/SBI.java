...
public class SBI implements RBI {
	...
	public void createAccount() {
		System.out.println("User Want To Create/Open Account");
	...
	private String getValidName() {
		...
		String name = sc.next();
		if (name.length() < 4) {
			System.out.println("Invalid Name.Plese Enter At Least Four Character Name");
			return getValidName();
		}
		try {
	...
	private String getValidMail() {
		...
		System.out.println("Invalid Mail Id Please Enter Valid Mail ID Ends With @gmail.com OR @yahoo.com");
		return getValidMail();
	}
	...
	private int selectBranch() {
		...
		System.out.println("2. Ahmednagar");
	...
	public void displayBalance() {
		if (getValidAccountNumber() == ac.getAccountNumber() && getValidPin() == ac.getAccountPin()) {
			System.out.println("User Want To Display Account Balance :");
	...
	public void displayDetails() {
		if (getValidAccountNumber() == ac.getAccountNumber() && getValidPin() == ac.getAccountPin()) {
			System.out.println("User Want To Display Account Details :");
	...
	public void depositeAmount() {
		Scanner sc = new Scanner(System.in);
		if (getValidAccountNumber() == ac.getAccountNumber() && getValidPin() == ac.getAccountPin()) {
			System.out.println("User Want To Deposite Amount ");
			System.out.println("How Much Amount Deposite ?");
	...
	public void withdrawAmount() {
		...
		if (getValidAccountNumber() == ac.getAccountNumber() && getValidPin() == ac.getAccountPin()) {
			...
			System.out.println("How Much Ammount Withdraw :- ");
			float withdraw = sc.nextFloat();
			float newBalance = ac.getBalanced() - withdraw;
			System.out.println("Remening Balance Is :- " + newBalance);
			ac.setBalanced(newBalance);
		} else {
			System.out.println("This Is Invalid Account Number Or Pin");
		}
	...
	public void updateProfile() {
		...
		do {
			if (getValidAccountNumber() == ac.getAccountNumber() && getValidPin() == ac.getAccountPin()) {
				System.out.println("User Want To Update Profile Details");
				System.out.println(
